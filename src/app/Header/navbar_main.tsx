...
const NavbarMain: React.FC = () => {
  ...
  return (
    <div className="w-full bg-white shadow-md z-50">
      ...
      <div className="flex items-center justify-between text-gray-500 text-sm px-4 md:px-20">
        ...
        <div className="hidden md:flex space-x-4 md:space-x-6">
          ...
          <Link
            href="/open-house"
            className="group flex items-center hover:text-secondary"
          >
      ...
      <div className="bg-primary py-4">
        ...
        {/* Navigation Links */}
        <div
          className={`md:flex justify-left space-x-8 text-white px-4 md:px-20 ${
            isOpen ? "block" : "hidden"
          } md:block`}
        >
          {/* Add Home Icon here */}
          ...
          <div className="relative group">
            <Link href="/personal" className="hover:text-secondary">
              Personal
            </Link>
          ...
          <Link href="/digital-banking" className="hover:text-secondary">
            Digital Banking
          </Link>
          <Link href="/news-media" className="hover:text-secondary">
            News & Media
          </Link>
